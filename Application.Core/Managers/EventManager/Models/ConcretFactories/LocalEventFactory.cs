...
public class LocalEventFactory(IMediator mediator): IEventAbstractFactory
{
    ...
    {
        var team = await mediator.Send(new GetTeamBySpectacleTypeQuery() { Type = SpectacleType.Local });
