...
using Infrastructure.Repositories.BusinessRepository.Music;
using Infrastructure.Repositories.BusinessRepository.Music.Interface;
using Infrastructure.Repositories.BusinessRepository.Playlist;
using Infrastructure.Repositories.BusinessRepository.Playlist.Interface;
using Infrastructure.Repositories.BusinessRepository.PlaylistMusic;
...
builder.Services.AddTransient<IPlaylistMusicRepository, PlaylistMusicRepository>();
