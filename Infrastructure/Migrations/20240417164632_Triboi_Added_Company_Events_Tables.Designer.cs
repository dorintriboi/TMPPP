...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240417164632_Triboi_Added_Company_Events_Tables")]
    partial class Triboi_Added_Company_Events_Tables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CompanyEvent.CompanyEventEntity", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.CompanyEventType.CompanyEventTypeEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("CompanyEventTypes");
                });

            modelBuilder.Entity("Domain.Entities.Contract.ContractEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.EmployeeCompanyEventType.EmployeeCompanyEventTypeEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Music.MusicEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.Playlist.PlaylistEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.PlaylistMusic.PlaylistMusicEntity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Entities.User.UserEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "e388578b-ee53-4045-aa00-ba96ae063c1f",
                            ...
                            PasswordHash = "AL1BIMMOhKvE7ZV1UV14VNpAf1FqXgMQc8O8kGHE8K73XpiswMjQByko9lf9PKtIag==",
            ...
            modelBuilder.Entity("Domain.Entities.CompanyEvent.CompanyEventEntity", b =>
                {
                    b.HasOne("Domain.Entities.CompanyEventType.CompanyEventTypeEntity", "Type")
                        .WithMany("Events")
            ...
            modelBuilder.Entity("Domain.Entities.EmployeeCompanyEventType.EmployeeCompanyEventTypeEntity", b =>
                {
                    b.HasOne("Domain.Entities.CompanyEventType.CompanyEventTypeEntity", "EventType")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Domain.Entities.PlaylistMusic.PlaylistMusicEntity", b =>
                {
                    b.HasOne("Domain.Entities.Playlist.PlaylistEntity", null)
                        .WithMany("Music")
            ...
            modelBuilder.Entity("Domain.Entities.Spectacle.SpectacleEntity", b =>
                {
                    b.HasOne("Domain.Entities.Playlist.PlaylistEntity", "Playlist")
                        .WithMany("Spectales")
